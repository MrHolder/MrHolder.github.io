...
if (!empty($fields))
{
    ...
    if (empty($error_list))
    {
        $subject = 'Новая заявка от ' . $fields['name'] . '.';

        //$content .= "-------\n" . $fields['message'] . "\r\n\n";
        $content .= "Контактные данные: " . $fields['contact_reason']
                . " \n\nИмя: " . $fields['name']
				. " \n\nТелефон: " . $fields['phone']
                . " \n\nEmail: " . $fields['email']
				. " \n\nВопрос: " . $fields['quest']	. " \n\n";

        if (mail($email_address, $subject, $content, "From: " . $fields['name'] . "\r\nReply-To: " . $fields['name'] . "\r\nReturn-Path: " . $fields['name'] . "\r\n"))
        //if (mail($email_address, $subject, $content, "From: " . $eml . "\r\nReply-To: " . $eml . "\r\nReturn-Path: " . $eml . "\r\n"))
		{
